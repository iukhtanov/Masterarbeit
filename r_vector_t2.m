...
% Optionen:
    ...
    % l1 - starting pointg (in m) -> Skalar
    % l2 - length (in m) -> Skalar
...
function [r_vector,r_x,r_y,r_z]=r_vector_t2(s,l1,l2,R,geometry,spacetype)
    ...
    r_tl=[spacefunc(l1,l1+l2,R),spacefunc(l1,l1+l2,R),l1,l1+l2];
