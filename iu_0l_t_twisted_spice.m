...
% Ausgabe:
    ...
    % comptime - Rechenzeit (in s) -> Skalar

function [plots,comptime]=iu_0l_t_twisted_spice(t,mu,epsilon,s,r_0,l,P,Z_1_n,Z_2_n,E_0,parameter,t_beta,k_vector,e_vector,time_func,quantity,typeof,geometry,d,losses)
    ...
    % Netzliste erstellen
    R=spice_source(filename,t,mu,epsilon,s,r_0,l_twisted,Z_1_n,Z_2_n,quantity,typeof,d,losses);
