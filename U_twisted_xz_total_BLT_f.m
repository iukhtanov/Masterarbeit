...
function output=U_twisted_xz_total_BLT_f(f,mu,epsilon,s,l,P,E_0,beta,k_vector,e_vector,Z_1_n,Z_2_n)
    ...
    for n=1:F
        % totaler Strom am Ende der Leitung (in A) -> Matrix(2,F)
        output(1:2,n)=U_twisted_xz_total_BLT(f(n),mu,epsilon,s,l,P,E_0,beta,k_vector,e_vector,Z_1_n,Z_2_n);
    end
end
